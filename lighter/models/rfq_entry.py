...
class RFQEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "account_index", "market_index", "direction", "base_amount", "quote_amount", "status", "metadata", "responses", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_construct(**{
            ...
            "quote_amount": obj.get("quote_amount"),
            "status": obj.get("status"),
            "metadata": RFQMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "responses": [RFQResponseEntry.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,
